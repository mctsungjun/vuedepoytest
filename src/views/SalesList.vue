        ...
        <table class="table table-bordered mt-2">
            ...
            <tbody>
                <tr :key="i" v-for="(product, i) in productList">
                    <td><img v-if="product.path!=null" :src="`https://port-0-servernode-m3cudz5w505940d1.sel4.cloudtype.app/download/${product.id}/${product.path}`" style="height:50px;width:auto;"/></td>
